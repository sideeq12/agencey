...
export const CustomTemplate: React.FC<CustomTemplateProps> = ({ data }) => {
    ...
    return (
        <div className="min-h-screen bg-white text-zinc-900 selection:bg-zinc-200 selection:text-black">
            ...
            {/* Hero */}
            <header className="pt-52 pb-20 px-6 relative overflow-hidden">
                ...
                <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
                    ...
                    >
                        <div className="inline-block px-3 py-1 rounded-full bg-zinc-100 border border-zinc-200 text-[10px] font-bold uppercase tracking-widest text-zinc-600">
            ...
            <Section className="py-24 px-6 bg-zinc-50">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[1, 2, 3, 4, 5, 6].map(i => (
                            <div key={i} className="p-8 rounded-[32px] bg-white border border-zinc-200 hover:border-purple-500/50 transition-colors group">
                                <div className="w-12 h-12 rounded-2xl bg-zinc-100 mb-6 group-hover:bg-purple-500/20 transition-colors" />
                                <h3 className="text-xl font-bold mb-4">Scalable Architecture</h3>
                                <p className="text-zinc-600 text-sm leading-relaxed">Custom engineering solutions tailored to your business needs.</p>
                            </div>
                        ))}
                    </div>
                </div>
                        ...
                        {[
                            ...
                            <div key={i} className="flex gap-12 group">
                                ...
                                <div>
                                    ...
                                    <p className="text-zinc-600 leading-relaxed max-w-xl">{p.desc}</p>
                                </div>
                            </div>
                        ))}
                    </div>
            ...
            <Section className="py-24 px-6 border-t border-zinc-200 bg-white">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-zinc-600">Why custom architectures outperform everything else.</p>
                    </div>
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                        <div className="space-y-8">
                            ...
                            <p className="text-zinc-600 text-lg">We don't take on every project. We only work with teams that are ready to redefine their category.</p>
                            <ImagePlaceholder text="Client Success Story" aspect="video" />
                        </div>
                        <div className="p-12 rounded-[50px] bg-white border border-zinc-200 shadow-xl italic text-xl leading-relaxed text-zinc-700">
            ...
            <Section className="py-24 px-6 bg-white border-y border-zinc-200">
                <div className="max-w-4xl mx-auto">
                    ...
                    <p className="text-zinc-600 text-center mb-12">Everything you need to know about our custom engineering services</p>
                    <Accordion items={[
                        {
            ...
            <Section className="py-32 px-6">
                <div className="max-w-4xl mx-auto p-12 md:p-20 rounded-[60px] bg-purple-600/10 border border-purple-500/20 shadow-[0_0_100px_rgba(168,85,247,0.1)]">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-zinc-600 text-lg max-w-xl mx-auto">Request a technical consultation today and see how we can transform your digital infrastructure.</p>
                    </div>
            ...
            <footer className="py-20 px-6 border-t border-zinc-200">
                <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-12">
                    ...
                    <div className="flex gap-12 text-xs font-bold uppercase tracking-widest text-zinc-500">
                        <a href="/custom" className="text-black">Custom Hub</a>
                        <a href="/webflow" className="hover:text-black">Webflow</a>
                        <a href="/wordpress" className="hover:text-black">WordPress</a>
