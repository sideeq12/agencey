        ...
        <div className="min-h-screen bg-white text-zinc-900 px-6">
            ...
            <Section className="py-24 border-t border-zinc-200 bg-zinc-50/50">
                <div className="max-w-7xl mx-auto">
                    <h2 className="text-[10px] font-bold uppercase tracking-[0.5em] text-zinc-600 text-center mb-16">Specialized Webflow Solutions</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {pages.slice(0, 9).map((page) => (
                            <Link
                                key={page.slug}
                                href={`/webflow/${page.slug}`}
                                className="group p-10 rounded-[40px] border border-zinc-200 hover:border-blue-500/50 transition-all bg-white flex flex-col justify-between"
                            >
                                <div>
            ...
            <Section className="py-24 border-t border-zinc-200 bg-white">
                <div className="max-w-7xl mx-auto">
                    <div className="mb-16 text-center">
                        <h2 className="text-4xl font-bold mb-4">Why Webflow Wins</h2>
                        <p className="text-zinc-600">Comparing performance against standard solutions.</p>
                    </div>
